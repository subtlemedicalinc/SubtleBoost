data_list=data_lists/data_test_tiantan_batch3.txt
...
path_base=/home/subtle/Data/Tiantan_Batch3_fake # path to dicom directories
path_out=/raid/jon/predictions/Tiantan_2019_04_05_2 # inference output dicoms
gpu=3
description="HoagModelNoScale" # append to dicom description
series=102 # series number
...
#cat ${data_list} | xargs -n1 -I{} python inference.py --path_base ${path_base}/{} --path_out ${path_out}/{} --verbose --slices_per_input 5 --num_channel_first 32 --gpu ${gpu} --checkpoint ${checkpoint_file} --discard_start_percent 0 --discard_end_percent 0 --normalize --normalize_fun mean --transform_type rigid --skip_scale_im --joint_normalize --skip_mask --description ${description} --series_num ${series} --zoom 320 --scale_dicom_tags --override_dicom_naming

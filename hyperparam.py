...
def train(params, gpu_ids):
    ...
    exp.log({'result': np.array(out.history['val_l1_loss'])})
    exp.save()

if __name__ == '__main__':
    parser = HyperOptArgumentParser(strategy='random_search')
    parser.add_argument('--test_tube_exp_name', default='hyp_test')
    ...
    hyp_params.optimize_parallel_gpu(train, gpu_ids=['0', '1'], max_nb_trials=10)

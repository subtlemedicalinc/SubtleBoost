...
def trainer_brats(args, G, D, snapshot_path):
    ...
    for epoch_num in trange(args.start_epoch, max_epoch):
        ...
        torch.save({'G':model_G.state_dict(), 'D':model_D.state_dict(), 'epoch': epoch_num, 'ssim': best_performance_ssim, 
                   'mse': best_performance_mse, 'mae': best_performance_mae, 'psnr': best_performance_psnr}, save_mode_path)

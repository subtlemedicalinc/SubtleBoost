...
class SwinUNet(nn.Module):
    ...
    def __init__(self, img_size=(160, 192), patch_size=4, in_chans=3, out_chans=1,
    ...
    def forward(self, x, contrast_embeds):
        enc_out = self.forward_encoder(x, contrast_embeds=contrast_embeds)
        dec_out = self.forward_decoder(enc_out, contrast_embeds=contrast_embeds)
        return dec_out

...
def evaluator_brats(model, scenarios, patient_list, model_path, vis_dir='vis'):
    metrics = []
...
metrics = evaluator_brats(generator, scenarios, test_patient, args.model_path, vis_dir=args.vis_dir)

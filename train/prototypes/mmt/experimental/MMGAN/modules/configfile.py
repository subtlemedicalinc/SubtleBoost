...
config['data_dir_prefix'] = "/mnt/datasets/jiang/projects/SubtleGAN/data/brats2021"  # this should be top level path
config['hdf5_filepath_prefix'] = "/mnt/raid/jiang/projects/SubtleGAN/data/brats2021/hdf5/BRATS2021_Unprocessed.h5" # top level path
...
config['hdf5_combined'] = "/mnt/raid/jiang/projects/SubtleGAN/data/brats2021/hdf5/BRATS_Combined_Unprocessed.h5"
config['hdf5_filepath_cropped'] = "/mnt/raid/jiang/projects/SubtleGAN/data/brats2021/hdf5/BRATS2021_Cropped_Normalized_Unprocessed.h5" # top level path
config['saveMeanVarFilepathHGG'] = "/mnt/raid/jiang/projects/SubtleGAN/data/brats2021/hdf5/BRATS2021_HDF5_Datasetstraining_data_hgg_mean_var.p"
config['saveMeanVarFilepathLGG'] = "/mnt/raid/jiang/projects/SubtleGAN/data/brats2021/hdf5/BRATS2021_HDF5_Datasetstraining_data_lgg_mean_var.p"
config['saveMeanVarCombinedData'] = "/mnt/raid/jiang/projects/SubtleGAN/data/brats2021/hdf5/combined_data_mean_var.p"

config['model_snapshot_location'] = "/mnt/raid/jiang/projects/SubtleGAN/model/MMGAN/model-snapshots/"
config['model_checkpoint_location'] = "/mnt/raid/jiang/projects/SubtleGAN/model/MMGAN/model-checkpoints/"
config['model_prediction_location'] = "/mnt/raid/jiang/projects/SubtleGAN/model/MMGAN/model-predictions/"
...
config['train_hgg_patients'] = 1186 # number of HGG patients in training

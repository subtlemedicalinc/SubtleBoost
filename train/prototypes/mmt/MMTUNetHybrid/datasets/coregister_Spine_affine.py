...
save_dir = f'/mnt/raid/jiang/projects/SubtleGAN/data/Spine_coregistered_affine/'
...
for case in tqdm(cases):
    ...
    try:
        ...
        _, t1_img, _ = register_im(sitk.GetArrayFromImage(t2_img), sitk.GetArrayFromImage(t1_img), ref_fixed=t2_img, ref_moving=t1_img, param_map=sitk.GetDefaultParameterMap('affine'), verbose=False)
        _, stir_img, _ = register_im(sitk.GetArrayFromImage(t2_img), sitk.GetArrayFromImage(stir_img), ref_fixed=t2_img, ref_moving=stir_img, param_map=sitk.GetDefaultParameterMap('affine'), verbose=False)
